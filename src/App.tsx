    ...
    <>
      ...
      <section className="container mx-auto px-4 py-12 md:py-16 lg:py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 text-balance">MEETINGOD</h1>
          <p className="text-lg md:text-xl text-primary mb-8 font-medium">スムーズな会議、はじめの一歩</p>
          ...
          <Link href="/create">
            <Button size="lg" className="text-base md:text-lg px-6 md:px-8 py-4 md:py-6 bg-primary hover:bg-primary/90">
              今すぐ会議を作成する
            </Button>
          </Link>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-foreground">テンプレートで会議の流れを作成</h3>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-foreground">共有リンクで参加者と情報共有</h3>
                </div>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-foreground">タイマーで時間管理</h3>
                </div>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
