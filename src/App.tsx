...
function App() {
  return (
    <>
        ...
        <section className="container mx-auto px-4 py-12 md:py-16 lg:py-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <Link to="/create">
              <Button
                size="lg"
                className="text-base md:text-lg px-6 md:px-8 py-4 md:py-6 bg-primary text-primary-foreground hover:bg-primary/90"
              >
                今すぐ会議を作成する
              </Button>
            </Link>
      ...
      {/* Tailwindが効いてるかチェック */}
      <div className="p-4 text-white bg-[hotpink] mt-6">TW OK</div>
    </>
  );
}
