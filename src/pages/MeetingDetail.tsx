...
import { useParams } from 'react-router-dom'; // Viteなので next/navigation ではなく react-router-dom
...
export default function MeetingDetail() {
  ...
  return (
    <div className="min-h-screen bg-background p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      {/* 省略: UI はほぼそのまま */}
      <Card className="flex flex-col items-center justify-center">
        ...
        <CardContent className="w-full space-y-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button onClick={() => setCurrentItemIndex((i) => i + 1)}>
              <SkipForward />
            </Button>
            <Button
              onClick={() => {
